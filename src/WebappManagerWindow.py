...
from gi.repository import Gtk, Gdk, Gio, XApp, GdkPixbuf, GLib  # noqa
...
class WebAppManagerWindow():
    def __init__(self, application):
        ...
        self.settings = Gio.Settings(schema_id="it.mijorus.webappmanager")
        ...
        self.builder.add_from_resource('/it/mijorus/webappmanager/gtk/webapp-manager.ui')
